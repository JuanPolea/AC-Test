...
class InternetConnectivityViewModel @Inject constructor() : ViewModel() {
    ...
    private val _internetConnectivityState = MutableStateFlow<InternetConnectivityState>(InternetConnectivityState.Idle)
    val internetConnectivityState = _internetConnectivityState.asStateFlow()
